...
public class SearchTask extends AsyncTask<Object, Object, Boolean> {
	...
	public SearchTask(final RetainFrag retainFrag, final String query) {
	...
	public String toString() {
		return "SearchTask " + super.toString() + ", retainFrag " + retainFrag;
	}
