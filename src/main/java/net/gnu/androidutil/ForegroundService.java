...
import net.gnu.agrep.AGrepActivity;
...
public class ForegroundService extends Service {
	...
	public static String ticker = "Text to Speech";
	public static String title = "Touch to Open";
	public static String text = "TTS Service";
    ...
    void handleCommand(Intent intent) {
        if (ACTION_FOREGROUND.equals(intent.getAction())) {
			...
			Log.i(TAG, ACTION_FOREGROUND);
            PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
																new Intent(this, AGrepActivity.class), 0);

            // Set the info for the views that show in the notification panel.
            Notification notification = new Notification.Builder(this)
				.setSmallIcon(R.drawable.search_2)  // the status icon
