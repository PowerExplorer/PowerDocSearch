...
public final class Andro7za {
	...
	private static final String mOutfile = SearcherAplication.PRIVATE_PATH + "/7zaOut.txt";
	private static final String mInfile = SearcherAplication.PRIVATE_PATH + "/7zaIn.txt";
	private static final String listFile = SearcherAplication.PRIVATE_PATH + "/7zaFileList.txt";
